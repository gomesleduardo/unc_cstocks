...
# SETTINGS --------------------------------------------------------------------
type_name <- 'tc__cropland_temporary_sugarcane_low'
...
for (x in c(socref_name, flu_name1, flu_name2, fmg_name1, fmg_name2, fi_name)) {
  load(
    file.path(
...
rm(dist_socref, dist_flu, dist_fmg, dist_fi, dist_soc, dist_cveg, dist_total,
   socref_name, flu_name1, flu_name2, fmg_name1, fmg_name2, fi_name, cveg_name)
