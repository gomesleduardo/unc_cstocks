...
# SETTINGS --------------------------------------------------------------------
type_name <- 'tc__cropland_permanent_generic_average_tillage_2017_high'
...
rm(list = ls()[!(ls() %in% c(
  ...
  'fmg_name1', 'fmg_name2', 'unc_factors__sugarcane',
  'fi_name', 'cveg_name', 'climate__micro', 'unc_cveg'
))])
...
for (x in c(socref_name, flu_name, fmg_name1, fmg_name2, fi_name)) {
  load(
    file.path(
...
rm(
  ...
  socref_name, flu_name, fmg_name1, fmg_name2, fi_name, cveg_name
)
