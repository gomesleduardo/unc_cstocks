...
# SETTINGS --------------------------------------------------------------------
type_name <- 'tc__natural_land_average'
socref_name <- 'samples__socref'
flu_name <- 'samples__grassland_land_use_flu_grassland'
# fmg_name <- 'samples__cropland_tillage_fmg_full'
...
#    socref_name, flu_name, fmg_name, fi_name)
rm(dist_socref, dist_flu, dist_soc, dist_cveg, dist_total,
   socref_name, flu_name, cveg_name)
...
#   file = file.path(
#     'cstocks/1__tc_microreg/samples/tc',
