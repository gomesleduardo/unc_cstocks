...
# SETTINGS --------------------------------------------------------------------
type_name <- 'tc__settlements_generic'
socref_name <- 'samples__socref'
flu_name <- 'samples__settlements_land_use_flu_settlements'
...
rm(dist_socref, dist_flu, dist_soc, dist_cveg, dist_total, socref_name)
